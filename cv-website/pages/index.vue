<template>
  <div class="flex justify-center items-center py-6 max-w-3xl mx-auto px-4">
    <div>
      <Logo />
      <h1 class="text-2xl py-6 text-center">
        Hey there 👋 I'm Luís!
      </h1>
      <div class="text-center text-gray-600">
        <p class="text-md py-1">
          I was born in Barcelos, Portugal
          {{ +new Date().getFullYear() - 1989 }} years ago.
        </p>
        <p class="text-md py-1">
          I'm a tech nerd, hyped about the next big thing. And yeah, I code for
          a living.
        </p>
        <p class="text-md py-1">
          I started my journey as a web developer and I grew into a full-stack
          guy who works with a tone of different technologies both frontend and
          backend, but I would say that my heart always will fall on the
          frontend.
        </p>
        <p class="text-md py-1">
          I've passion for learning new things, embrace challenges and I also
          consider myself a problem solver.
        </p>
        <p class="text-md py-1">
          I enjoy gaming, listen to music and (as everyone else in the last 5
          years) love to listen to podcast on a variety of subjects (tech,
          coding, comedy, politics).
        </p>
      </div>
      <hr class="my-6" />
      <div>
        <h2 class="text-center text-gray-600">
          This space is still under construction, but you can always get more
          information about me in:
        </h2>
        <div class="grid sm:grid-rows-1 grid-rows-2 grid-flow-col gap-4 py-6">
          <div class="flex-1 text-center">
            <a
              href="https://twitter.com/Simoesdaniel89"
              class="relative text-center text-xs"
              ><span
                ><svg
                  aria-hidden="true"
                  width="25"
                  height="25"
                  viewBox="0 0 18 18"
                  class="absolute iconTwitter right-11 svg-icon"
                >
                  <path
          ...
          <div class="flex-1 text-center">
            <a
              href="https://linkedin.com/in/luisdanielsimoes/"
          ...
          <div class="flex-1 text-center">
            <a
              href="https://stackoverflow.com/users/5534634/lu%c3%ads-daniel-sim%c3%b5es"
              class="relative text-xs"
              ><span
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex-1 text-center">
            <a href="https://github.com/simoesdaniel" class="relative text-xs"
              ><span
                ><svg
                  aria-hidden="true"
                  width="25"
                  height="25"
                  viewBox="0 0 18 18"
                  class="absolute iconGitHub right-11 svg-icon"
                >
                  <path
